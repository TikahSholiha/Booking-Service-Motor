...
<head>
    ...
    <style>
    body{
    background-image: url(motor.jpeg);
...
<body>
    ...
    <div class="boxlogin">
        ...
        <form method="post" action="tampil.php">
            <input type="text" name="" placeholder="Masukan Nama">
            <input type="text" name="" placeholder="Masukan No.Plat">
            <input type="text" name="" placeholder="Masukan Merek Motor">
